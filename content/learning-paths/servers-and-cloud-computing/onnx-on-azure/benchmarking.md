...
libprotoc x.x
```
If installation via the package manager fails, or the version is too old for ONNX Runtime; then proceed with [installing Protobuf using the Aarch64 pre-built zip artifact](https://github.com/protocolbuffers/protobuf/releases), as discussed below.
